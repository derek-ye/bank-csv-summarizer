...
/* package bank-csv-summarizer-0.1.0.0 */
#ifndef VERSION_bank_csv_summarizer
#define VERSION_bank_csv_summarizer "0.1.0.0"
#endif /* VERSION_bank_csv_summarizer */
#ifndef MIN_VERSION_bank_csv_summarizer
#define MIN_VERSION_bank_csv_summarizer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_bank_csv_summarizer */
...
#define CURRENT_COMPONENT_ID "bank-csv-summarizer-0.1.0.0-inplace-bank-csv-summarizer"
